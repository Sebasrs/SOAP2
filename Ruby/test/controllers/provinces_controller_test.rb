...
class ProvincesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create province" do
    assert_difference('Province.count') do
      post provinces_url, params: { province: { Country_idCountry: @province.Country_idCountry, name: @province.name } }
    end
  ...
  test "should update province" do
    patch province_url(@province), params: { province: { Country_idCountry: @province.Country_idCountry, name: @province.name } }
